...
public class FhirUtil {
    ...
    public static String createCdaDocument(CaseReportForm caseReportForm) throws Exception {
        ...
        addSection(composition, TITLE_CURRENT_WHO_STAGE, CaseReportConstants.TERM_CODE_WHO_STAGE, TEXT_CURRENT_WHO_STAGE,
                false, Arrays.asList(caseReportForm.getCurrentHivWhoStage()));

        addSection(composition, TITLE_CURRENT_ARVS, CaseReportConstants.TERM_CODE_CURRENT_ARVS, TEXT_CURRENT_ARVS, false,
                caseReportForm.getCurrentHivMedications());
